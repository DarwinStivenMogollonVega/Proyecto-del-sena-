<?php $__env->startSection('titulo', $catalogo->nombre . ' - DiscZone'); ?>

<?php $__env->startPush('estilos'); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/dz-responsive.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/catalogo-section.css')); ?>">
...
<form method="GET" action="<?php echo e(route('web.catalogo.show', $catalogo->getKey())); ?>" class="search-panel p-3 p-md-4 mt-4">
...
<?php echo $__env->make('web.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\proyecto para corregir }\proyecto actual\Proyecto-del-sena-\resources\views/web/catalogo.blade.php ENDPATH**/ ?>