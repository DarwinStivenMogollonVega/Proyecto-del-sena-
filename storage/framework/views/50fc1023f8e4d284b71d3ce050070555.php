...
<?php $__env->startSection('titulo', $artista->nombre . ' - DiscZone'); ?>
...
<div class="container px-4 px-lg-5">
    <section class="store-hero p-4 p-lg-5">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="display-6 fw-bold mb-2"><?php echo e($artista->nombre); ?></h1>
                <?php if(!empty($artista->biografia)): ?>
                    <p class="mb-0 hero-subtitle"><?php echo e(\Illuminate\Support\Str::limit($artista->biografia, 220)); ?></p>
                <?php else: ?>
            ...
            <div class="col-lg-4 mt-4 mt-lg-0 text-lg-end">
                <?php if($artista->foto): ?>
                    <img src="<?php echo e(asset('uploads/artistas/' . $artista->foto)); ?>" alt="<?php echo e($artista->nombre); ?>" class="img-fluid rounded" style="max-height:120px;">
                <?php endif; ?>
            </div>
        </div>
    </section>
...
<form method="GET" action="<?php echo e(route('web.artista.show', $artista->getKey())); ?>" class="search-panel p-3 p-md-4 mt-4">
                ...
                <article class="all-product-card">
                    <div class="all-product-cover">
                        ...
                        <?php elseif($stockAll > 0): ?>
                            <span class="all-product-stock badge bg-warning text-dark"><i class="bi bi-tag-fill me-1"></i>$<?php echo e(number_format($producto->precio * (1 - (($producto->descuento ?? 0)/100)), 2)); ?></span>
                        <?php else: ?>
                    ...
                    <div class="all-product-body">
                        ...
                        <?php elseif($stockAll > 0): ?>
                            <span class="all-product-discount"><i class="bi bi-tag-fill me-1"></i>$<?php echo e(number_format($producto->precio * (1 - (($producto->descuento ?? 0)/100)), 2)); ?></span>
                        <?php else: ?>
...
<?php echo $__env->make('web.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\proyecto para corregir }\proyecto actual\Proyecto-del-sena-\resources\views/web/artista.blade.php ENDPATH**/ ?>