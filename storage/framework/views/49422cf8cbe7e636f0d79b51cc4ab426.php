                    ...
                    <div class="p-0" id="cartItems">
                        ...
                        <div class="row align-items-center cart-row py-3" style="border-bottom: 1px solid #3a2417;">
                            ...
                            <div class="col-2 text-center cart-price">
                                <span class="cart-price-value" style="color:#ff9900; font-weight:600; font-size:1.1rem;">$<?php echo e(number_format($item['precio'], 2)); ?></span>
                            </div>
                            ...
                            <div class="col-2 text-end">
                                <span class="cart-subtotal" style="color:#ff9900; font-weight:600; font-size:1.1rem;">$<?php echo e(number_format($item['precio'] * $item['cantidad'], 2)); ?></span>
                            </div>
