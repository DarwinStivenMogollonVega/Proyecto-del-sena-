<nav class="app-header navbar navbar-expand bg-body">
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="<?php echo e(route('dashboard')); ?>" class="nav-link">Panel principal</a></li>
            <li class="nav-item d-none d-md-block"><a href="<?php echo e(route('web.index')); ?>" class="nav-link">Tienda</a></li>
            <li class="nav-item d-none d-md-block"><a href="<?php echo e(route('admin.guia')); ?>" class="nav-link">Soporte</a></li>
        </ul>
            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <li class="user-header admin-user-header">
                        <div class="admin-user-avatar-lg"><?php echo e($adminInitial); ?></div>
                    ...
                    <li class="user-footer">
                        <a href="<?php echo e(route('perfil.edit')); ?>" class="btn btn-default btn-flat admin-user-action">Perfil</a>
    ...
    <!--end::Container-->
</nav><?php /**PATH /var/www/laravelapp/resources/views/plantilla/header.blade.php ENDPATH**/ ?>