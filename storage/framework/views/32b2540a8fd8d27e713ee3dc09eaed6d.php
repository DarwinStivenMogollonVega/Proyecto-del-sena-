...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="card" style="border-radius:1rem">
                <div class="card-header py-3 d-flex flex-wrap align-items-center justify-content-between gap-2">
                    ...
                    <a href="<?php echo e(route('estadisticas.show', ['categoria' => 'proveedores'])); ?>" class="btn btn-sm btn-outline-primary">
        ...
        <div class="col-md-8 col-lg-8">
            <div class="card h-100" style="border-radius:1rem">
                <div class="card-header py-3 d-flex align-items-center justify-content-between">
                    ...
                    <a href="<?php echo e(route('admin.pedidos')); ?>" class="btn btn-sm btn-outline-primary px-3" style="font-size:.78rem">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0" style="font-size:.85rem">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="px-3 fw-semibold"><?php echo e($pedido->id); ?></td>
                                    <td>
        ...
        <div class="col-md-6">
            <div class="card h-100" style="border-radius:1rem">
                <div class="card-header py-3 d-flex align-items-center justify-content-between">
                    ...
                    <a href="<?php echo e(route('usuarios.index')); ?>" class="btn btn-sm btn-outline-primary px-3" style="font-size:.78rem">
        ...
        <div class="col-lg-4">
            <div class="card h-100" style="border-radius:1rem">
                <div class="card-header py-3 d-flex align-items-center justify-content-between">
                    ...
                    <a href="<?php echo e(route('usuarios.index')); ?>" class="btn btn-sm btn-outline-primary px-2" style="font-size:.75rem">
                        Ver todos
                    </a>
                </div>
                <div class="card-body">
    ...
    <div class="card mb-4" style="border-radius:1rem">
        ...
        <div class="card-body pt-2">
            <div class="row g-2">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['user-list','rol-list'])): ?>
                <div class="col-12 col-md-4">
                    <a href="<?php echo e(route('admin.seguridad.index')); ?>" class="module-card h-100">
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['producto-list', 'artista-list', 'categoria-list', 'catalogo-list'])): ?>
    <div class="card mb-4" style="border-radius:1rem">
        <div class="card-header py-3 d-flex align-items-center gap-2">
        ...
        <div class="card-body pt-2">
            <div class="row g-2">
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('catalogo-list')): ?>
                <div class="col-12 col-md-3">
                    <a href="<?php echo e(route('catalogo.index')); ?>" class="module-card h-100">
...
<?php echo $__env->make('plantilla.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/laravelapp/resources/views/dashboard.blade.php ENDPATH**/ ?>