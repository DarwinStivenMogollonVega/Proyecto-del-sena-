...
<html lang="es">
  ...
  <body class="layout-fixed sidebar-expand-lg admin-shell">
    ...
    <div class="app-wrapper">
      ...
      <!--end::Header-->
      <!--begin::Sidebar-->
      <?php echo $__env->make('plantilla.menu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
      <!--end::Sidebar-->
      <!--begin::App Main-->
      <main class="app-main">
...
<?php /**PATH C:\Proyectos\proyecto para corregir }\proyecto actual\Proyecto-del-sena-\resources\views/plantilla/app.blade.php ENDPATH**/ ?>