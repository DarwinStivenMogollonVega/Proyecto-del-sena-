<?php if (! $__env->hasRenderedOnce('60f349a7-d6fd-4ecd-969f-faa4da0ff6dd')): $__env->markAsRenderedOnce('60f349a7-d6fd-4ecd-969f-faa4da0ff6dd'); ?>
<style>
    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['user-list', 'rol-list', 'producto-list', 'proveedor-list', 'artista-list', 'categoria-list', 'catalogo-list'])): ?>
                ...
                <li class="nav-item" id="mnuSeguridad">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['rol-list', 'user-list'])): ?>
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.seguridad.index')); ?>" class="nav-link" id="mnuSeguridadPanel">
                ...
                <li class="nav-item" id="mnuCatalogo">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('catalogo.index')); ?>" class="nav-link" id="itemCatalogo">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/laravelapp/resources/views/plantilla/menu.blade.php ENDPATH**/ ?>