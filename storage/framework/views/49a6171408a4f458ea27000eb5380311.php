...
<link rel="stylesheet" href="<?php echo e(asset('css/categoria-section.css')); ?>">
...
<?php $__env->startSection('contenido'); ?>
   <div class="container px-4 px-lg-5">
    ...
    <div class="row g-3 mt-2 mb-4">
        ...
        <div class="col-6 col-md-3"><div class="metric-pill"><strong><?php echo e($productos->unique('catalogo_id')->count()); ?></strong><span>Catálogos</span></div></div>
    </div>
...
<section class="all-products-section mt-5">
    <div class="all-products-head d-flex align-items-center" style="gap:0.7rem;">
        <h4 class="mb-0 d-flex align-items-center"><i class="bi bi-grid-3x3-gap-fill me-2"></i>Productos de <?php echo e($categoria->nombre); ?>
