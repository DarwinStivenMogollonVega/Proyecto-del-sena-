...
<div class="container px-4 px-lg-5">
    ...
    <section id="productos" class="mt-5">
        <?php $__currentLoopData = [
            ['title' => 'Los mas vendidos', 'icon' => 'bi-trophy-fill', 'items' => $masMasVendidos],
                            ...
                            <div class="product-carousel-item">
                                <article class="all-product-card">
                                    <div class="all-product-cover">
                                        ...
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('img/no-image.svg')); ?>" alt="Sin imagen" loading="lazy">
                                        <?php endif; ?>
    ...
    <section class="featured-section">
        <div class="featured-head d-flex align-items-center" style="gap:0.7rem;">
            <h4 class="mb-0 d-flex align-items-center"><i class="bi bi-chat-left-text-fill me-2"></i>Los mejor comentados
                <span class="section-badge ms-2"><?php echo e($masMasVendidos->count() ?: $mejorValorados->count()); ?> productos</span>
            </h4>
        </div>

        <?php
            $featured = $masMasVendidos->isNotEmpty() ? $masMasVendidos : $mejorValorados;
        ?>
        ...
        <?php if($featured->isNotEmpty()): ?>
            <div class="product-carousel" data-carousel>
                ...
                <div class="product-carousel-track" data-carousel-track>
                    <?php $__currentLoopData = $featured; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $stockLocal  = (int) ($producto->cantidad ?? 0);
                            $ratingLocal = round((float) ($producto->resenas_avg_puntuacion ?? 0), 1);
                            $rCountLocal  = (int) ($producto->resenas_count ?? 0);
        ...
        <?php else: ?>
            <div class="text-center py-4 text-muted">No hay productos destacados para mostrar.</div>
        <?php endif; ?>
    </section>
</div>
<?php $__env->stopSection(); ?>
