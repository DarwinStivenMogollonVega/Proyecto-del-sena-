                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $registros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>#<?php echo e($reg->pedido->id); ?></td>
                                ...
                                <td>
                                    <a href="<?php echo e(route('perfil.facturas.show', $reg->id)); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('web.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/laravelapp/resources/views/web/recibos_factura.blade.php ENDPATH**/ ?>