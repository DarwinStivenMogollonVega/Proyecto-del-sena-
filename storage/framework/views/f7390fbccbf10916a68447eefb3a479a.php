...
<div class="container px-4 px-lg-5">
    <div class="store-hero p-4 p-lg-5">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="display-6 fw-bold mb-2">Catálogo de productos</h1>
                <p class="mb-0 hero-subtitle">Explora todos los productos disponibles en la tienda.</p>
            </div>
            <div class="col-lg-4 mt-4 mt-lg-0 text-lg-end">
                <a href="<?php echo e(route('web.index')); ?>" class="btn btn-outline-dark px-4">Volver al inicio</a>
            </div>
        </div>
    </div>
    ...
    <form id="explorar" method="GET" action="<?php echo e(route('web.productos')); ?>" class="search-panel p-3 p-md-4 mt-4">
    ...
    <section class="all-products-section mt-4">
                        ...
                        <article class="all-product-card">
                            <div class="all-product-cover">
                                <?php if($producto->imagen): ?>
                                    <img src="<?php echo e(asset('uploads/productos/' . $producto->imagen)); ?>" alt="<?php echo e($producto->nombre); ?>" loading="lazy">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('img/no-image.jpg')); ?>" alt="Sin imagen" loading="lazy">
                                <?php endif; ?>
                                <?php if($stockAll >= 50): ?>
                            ...
                            <div class="all-product-body">
                                ...
                                <?php elseif($stockAll > 0): ?>
                                    ...
                                    <?php else: ?>
                                        <span class="all-product-discount"><i class="bi bi-tag-fill me-1"></i>$<?php echo e(number_format($producto->precio, 2)); ?></span>
                                    <?php endif; ?>
                                <?php else: ?>
...
<?php echo $__env->make('web.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\proyecto para corregir }\proyecto actual\Proyecto-del-sena-\resources\views/web/productos.blade.php ENDPATH**/ ?>