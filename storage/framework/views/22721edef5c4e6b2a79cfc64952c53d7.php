...
<link rel="stylesheet" href="<?php echo e(asset('css/acerca-section.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/responsive-section.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/footer-section.css')); ?>">
<?php $__env->stopPush(); ?>
...
<div class="container px-4 px-lg-5 pb-5 acerca-theme-root">
    <section class="about-hero text-center mb-4">
        <h1 class="fw-bold mb-2 about-title-primary">Acerca de DiscZone</h1>
        <p class="lead mb-3">
    ...
    <section class="mt-4">
        <div class="row g-3 justify-content-center">
            ...
            <div class="col-12 col-md-4 mb-3">
                <div class="about-card h-100 shadow-sm rounded about-bg-light">
                    <h5 class="fw-bold about-title-primary">Compra guiada</h5>
                    <p>
            ...
            <div class="col-12 col-md-4 mb-3">
                <div class="about-card h-100 shadow-sm rounded about-bg-light">
                    <h5 class="fw-bold about-title-primary">Seguimiento del usuario</h5>
                    <p>
    ...
    <section class="about-block mt-4">
        <div class="about-card p-4 rounded shadow-sm about-bg-light">
            ...
            <div class="about-highlight mt-2 p-3 rounded">
                <span class="fw-bold about-title-warning">En resumen, DiscZone es una tienda musical centrada en el usuario: descubrir, comprar y dar seguimiento a sus pedidos en un solo lugar.</span>
            </div>
        </div>
    </section>
    ...
    <section class="about-responsive mt-5">
        <h3 class="fw-bold mb-4 text-center about-title-primary">Adaptabilidad visual según el dispositivo</h3>
        <div class="row g-4">
            <div class="col-12 col-md-4">
                <div class="about-card h-100 shadow-sm rounded about-bg-light">
                    <h5 class="fw-bold about-title-primary mb-2">Vista adaptable desde un celular</h5>
                    <ul class="mb-2">
                    ...
                    <div class="text-center">
                        <i class="bi bi-phone display-6 about-title-primary"></i>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4">
                <div class="about-card h-100 shadow-sm rounded about-bg-light">
                    <h5 class="fw-bold about-title-success mb-2">Vista adaptable desde un computador</h5>
                    <ul class="mb-2">
                    ...
                    <div class="text-center">
                        <i class="bi bi-laptop display-6 about-title-success"></i>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4">
                <div class="about-card h-100 shadow-sm rounded about-bg-light">
                    <h5 class="fw-bold about-title-warning mb-2">Vista adaptable desde un televisor</h5>
                    <ul class="mb-2">
                    ...
                    <div class="text-center">
                        <i class="bi bi-tv display-6 about-title-warning"></i>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('web.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\proyecto para corregir }\proyecto actual\Proyecto-del-sena-\resources\views/web/acerca.blade.php ENDPATH**/ ?>