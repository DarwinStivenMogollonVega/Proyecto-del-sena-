...
<div class="container px-4 px-lg-5 mt-5 wishlist-container">
    ...
    <div class="wishlist-section rounded shadow-sm p-4">
        ...
        <?php if(auth()->check() && \Illuminate\Support\Facades\Schema::hasTable('lista_deseos')): ?>
            <?php
                                    ...
                                    <?php elseif($stock > 0): ?>
                                        <?php if(!empty($p->descuento) && $p->descuento > 0): ?>
                                            <p class="all-product-discount carousel-price">
                                                ...
                                                $<?php echo e(number_format($p->precio * (1 - ($p->descuento/100)), 2)); ?>

                                                <span class="text-decoration-line-through text-muted ms-2">$<?php echo e(number_format($p->precio, 2)); ?></span>
                                                <span class="badge bg-warning text-dark ms-2">- <?php echo e(number_format($p->descuento, 2)); ?>% descuento</span>
                                            </p>
                                        <?php else: ?>
                                            <span class="all-product-discount"><i class="bi bi-tag-fill me-1"></i>$<?php echo e(number_format($p->precio, 2)); ?></span>
                                        <?php endif; ?>
                                    <?php else: ?>
                                ...
                                <div class="all-product-body">
                                    ...
                                    <?php elseif($stock > 0): ?>
                                        ...
                                        <?php if($itmDesc > 0): ?>
                                            <p class="all-product-discount carousel-price">
                                                <i class="bi bi-tag-fill me-1"></i>
                                                $<?php echo e(number_format($itmPrice * (1 - ($itmDesc/100)), 2)); ?>

                                                <span class="text-decoration-line-through text-muted ms-2">$<?php echo e(number_format($itmPrice, 2)); ?></span>
                                                <span class="badge bg-warning text-dark ms-2">- <?php echo e(number_format($itmDesc, 2)); ?>% descuento</span>
                                            </p>
                                        <?php else: ?>
                                            <span class="all-product-discount"><i class="bi bi-tag-fill me-1"></i>$<?php echo e(number_format($itmPrice, 2)); ?></span>
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <span class="all-product-discount"><i class="bi bi-x-circle me-1"></i>Agotado</span>
                                    <?php endif; ?>
