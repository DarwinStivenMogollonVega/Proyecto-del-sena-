<?php $__env->startSection('titulo', 'DiscZone - Restablecer contrasena'); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="input-group mb-2">
          <div class="form-floating">
            <input id="loginPassword" type="password" name="password" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Nueva contrasena" />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="input-group mb-2">
          <div class="form-floating">
            <input id="password_confirmation" type="password" name="password_confirmation" class="form-control <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Confirmar contrasena" />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 pt-2">
          ...
          <a href="<?php echo e(route('login')); ?>" class="auth-link fw-semibold">Ir al login</a>
        </div>
      </form>
    </div>
  </section>
...
<?php echo $__env->make('autenticacion.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\proyecto para corregir }\proyecto actual\Proyecto-del-sena-\resources\views/autenticacion/reset.blade.php ENDPATH**/ ?>