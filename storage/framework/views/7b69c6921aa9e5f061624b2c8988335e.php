...
<?php $__env->startPush('estilos'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/dashboard-cliente.css')); ?>">
    ...
    <section class="client-hero">
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <p class="mb-0 hero-subtitle">Hola <?php echo e(auth()->user()->name); ?>, aqui tienes un resumen visual de tus compras, pedidos, intereses y carrito actual.</p>
            </div>
                            ...
                            <table class="table table-hover client-table mb-0">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $ultimosPedidos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pedido): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="fw-semibold">#<?php echo e($pedido->getKey()); ?></td>
...
<?php echo $__env->make('web.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Proyectos\proyecto para corregir }\proyecto actual\Proyecto-del-sena-\resources\views/web/dashboard_cliente.blade.php ENDPATH**/ ?>