...
<div class="container px-4 px-lg-5">
    <div class="store-hero p-4 p-lg-5">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 mt-4 mt-lg-0 text-lg-end">
                <a href="{{ route('web.index') }}" class="btn btn-outline-dark px-4">Volver al inicio</a>
            </div>
        </div>
    </div>
    ...
    <form id="explorar" method="GET" action="{{ route('web.productos') }}" class="search-panel p-3 p-md-4 mt-4">
                ...
                @foreach ($productos as $producto)
                        ...
                        <article class="all-product-card">
                            <div class="all-product-cover">
                                ...
                                @else
                                    <img src="{{ asset('img/no-image.jpg') }}" alt="Sin imagen" loading="lazy">
                                @endif
                                @if ($stockAll >= 50)
