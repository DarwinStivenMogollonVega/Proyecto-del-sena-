                            ...
                            <div class="product-carousel-item">
                                <article class="all-product-card">
                                    ...
                                    <div class="all-product-body">
                                        ...
                                        @else
                                            <p class="all-product-discount carousel-price"><i class="bi bi-tag-fill me-1"></i>${{ number_format($producto->precio, 2) }}</p>
                                        @endif
    ...
    <section class="featured-section">
        <div class="featured-head d-flex align-items-center" style="gap:0.7rem;">
            <h4 class="mb-0 d-flex align-items-center"><i class="bi bi-chat-left-text-fill me-2"></i>Los mejor comentados
                <span class="section-badge ms-2">{{ $masMasVendidos->count() ?: $mejorValorados->count() }} productos</span>
            </h4>
        </div>
