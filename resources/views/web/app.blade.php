...
<head>
    ...
    <body>
    {{-- If a view provides a `manual_nav` section, render it here (allows manual placement).
         Otherwise fall back to the standard conditional include. --}}
    @if(View::hasSection('manual_nav'))
        @yield('manual_nav')
    @else
