...
@section('hide_nav_actions')@endsection
@section('contenido')
                            ...
                            <div style="flex:1">
                                    <div class="mb-2">
                                        ...
                                        <div style="display:flex;gap:.5rem;align-items:center;">
                                            <input id="avatarCropSize" name="avatar_crop_size" type="number" min="{{ config('avatar.crop_min', 100) }}" max="{{ config('avatar.crop_max', 800) }}" step="1" value="260" class="form-control form-control-sm" style="width:120px;">
