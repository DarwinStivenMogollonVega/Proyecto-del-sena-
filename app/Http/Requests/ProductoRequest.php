...
class ProductoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'catalogo_id' => ['required', 'exists:catalogos,catalogo_id'],
    ...
    public function messages(): array
    {
        return [
            ...
            'catalogo_id.required' => 'Debes seleccionar un catálogo para el producto.',
            'catalogo_id.exists' => 'El catálogo seleccionado no existe o ya no está disponible.',
